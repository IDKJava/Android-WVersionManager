...
public class WVersionManager implements IWVersionManager {
    ...
    public interface WVersionManagerEventListener {
    ...
    private WVersionManagerEventListener eventListener;
    ...
    /**
     * Set the listener for button clicks in the version updater dialog
     * 
     * @param listener
     *            the listener to use or null to clear listeners
     */
    public void setEventListener(WVersionManagerEventListener listener) {
    ...
    private long getReminderTime() {
        return PreferenceManager.getDefaultSharedPreferences(activity).getLong(PREF_REMINDER_TIME,
                0);
    }
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            case AlertDialog.BUTTON_POSITIVE:
                if (eventListener != null) {
                    eventListener.onUpdateNowClicked();
                }
                updateNow(getUpdateUrl());
                break;
            case AlertDialog.BUTTON_NEUTRAL:
                if (eventListener != null) {
                    eventListener.onRemindLaterClicked();
                }
                remindMeLater(getReminderTimer());
                break;
            case AlertDialog.BUTTON_NEGATIVE:
                if (eventListener != null) {
                    eventListener.onSkipVersionClicked();
                }
                ignoreThisVersion();
                break;
            }
